keySocket.init("nexflix", {
  "play-pause": function() {
    var playPauseButton = document.querySelector(
      ".button-nfplayerPlay, .button-nfplayerPause"
    );
  ...
  prev: function() {
    ...
    if (episodeList) {
      prevButtonEpisode = episodeList.previousElementSibling.querySelector(
        "div.play-icon"
      );
      if (prevButtonEpisode) {
        episodeList.previousElementSibling.className +=
          " episode-list-item--expanded";
