...
function ustream_play() {
  ...
  injscript.appendChild(
    document.createTextNode("window.ustream.app.player.viewer.play()")
  );
...
function ustream_pause() {
  ...
  injscript.appendChild(
    document.createTextNode("window.ustream.app.player.viewer.pause()")
  );
  (document.body || document.head || document.documentElement).appendChild(
    injscript
  );
...
keySocket.init("ustream", function(key) {
