...
keySocket.init = function(name, handlers) {
  chrome.runtime.onMessage.addListener(function(request) {
    ...
    if (typeof handlers === "function") {
      ...
      // independent handlers (per command (key) -- function or selector)
      switch (request.command) {
        case keySocket.PLAY:
          handlers[keySocket.PLAY] && keySocket.call(handlers[keySocket.PLAY]);
          break;
        case keySocket.STOP:
          handlers[keySocket.STOP] && keySocket.call(handlers[keySocket.STOP]);
          break;
        case keySocket.PREV:
          handlers[keySocket.PREV] && keySocket.call(handlers[keySocket.PREV]);
          break;
        case keySocket.NEXT:
          handlers[keySocket.NEXT] && keySocket.call(handlers[keySocket.NEXT]);
          break;
      }
    }
  });
